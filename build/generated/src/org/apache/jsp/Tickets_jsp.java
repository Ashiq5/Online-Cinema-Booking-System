...
public final class Tickets_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        </div>\n");
      out.write("        <div align=\"right\"><font color=\"black\" style=\"font-size:20px\">\n");
      out.write("            ");
      ...
      out.write("            <table>\n");
      out.write("                <form action=\"userpage\"> \n");
      out.write("                <tr>\n");
      ...
      out.write("            ");
            ...
            {//session.setAttribute("ope",transactions);
                ...
                for(TicketTime trans: transactions)
                {
                    ...
                    out.println( String.format("<td>%s</td><td>%d</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%d</td>", s, trans.hall_no, trans.movie_name,trans.date,trans.start_time,trans.hall_type,trans.price) );
      ...
      out.write("            ");
            ...
            {//session.setAttribute("ope",transactions);
                ...
                for(TicketTime trans: transaction)
                {
                    ...
                    out.println( String.format("<td>%s</td><td>%s</td><td>%d</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%d</td>", s,trans.Ticket_no, trans.hall_no, trans.movie_name,trans.date,trans.start_time,trans.hall_type,trans.price) );
                    //out.println("<input type=\"hidden\" id=\"dd\" name=\"prod\" value=\"\"/>");
                    //session.setAttribute("flag", trans.movie_name);
                    //session.setAttribute("operation", trans.hall_type);
